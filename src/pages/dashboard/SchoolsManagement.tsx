      ...
      <div className="bg-surface-800 rounded-xl border border-surface-700 overflow-hidden">
        ...
        <table className="w-full min-w-[750px]">
          <thead className="bg-surface-900">
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-slate-300 uppercase tracking-wider">School Name</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-slate-300 uppercase tracking-wider">Contact Email</th>
            ...
            {isLoading ? (
              ...
              filteredSchools.map((school) => (
                <tr key={school.id} className="hover:bg-surface-700/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-slate-300">{school.state}</td>
