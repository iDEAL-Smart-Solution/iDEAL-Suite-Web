...
const ProductMonitoring = () => {
  ...
  if (!isLoading && products.length === 0 && !error) {
    return (
      <div>
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-8">Product Monitoring</h1>
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        subtitle="View and manage available products for your school"
      />
      ...
      {!isLoading && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 pt-8 border-t border-surface-700">
          ...
          <div className="text-center">
            ...
            <p className="text-2xl md:text-3xl font-bold text-green-400">{activeCount}</p>
          </div>
          <div className="text-center">
            <p className="text-slate-400 mb-2">Inactive</p>
            <p className="text-2xl md:text-3xl font-bold text-red-400">{inactiveCount}</p>
          </div>
        </div>
      )}
    </div>
